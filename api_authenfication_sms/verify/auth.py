...
def check_verification(phone, code):
    ...
    try:
        ...
        if verification_check.status == "approved":
            ...
            db.commit()
            flash('Votre numero de téléphone a été vérifié! Veillez vous connecter pour continuer.')
            return redirect(url_for('auth.login'))
        else:
            flash('Le code saisi est incorrect. Veillez ressayer.')
    except Exception as e:
        flash("Erreur de validation de code: {}".format(e))
